...
describe('ripple-cdr-openehr/lib/handlers/checkNhsNumber', () => {
  ...
  beforeEach(() => {
    ...
    checkNhsNumberHandler = require('../../../lib2/handlers/checkNhsNumber');
  });
  ...
  it('should return response object', async () => {
    ...
    command.execute.and.returnValue(Promise.resolve(responseObj));

    await checkNhsNumberHandler(args, finished);
  ...
  it('should return error object', async () => {
    command.execute.and.returnValue(Promise.reject(new Error('custom error')));
