...
describe('ripple-cdr-openehr/lib/commands/deletePatientHeading', () => {
  ...
  it('should delete patient heading and return response', async () => {
    ...
    expect(headingService.fetchAll).toHaveBeenCalledWith(9999999111, 'procedures');
    expect(headingService.delete).toHaveBeenCalledWith(9999999111, 'procedures', 'eaf394a9-5e05-49c0-9c69-c710c77eda76');
    expect(discoveryService.delete).toHaveBeenCalledWith('eaf394a9-5e05-49c0-9c69-c710c77eda76');
